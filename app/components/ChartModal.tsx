...
export default function ChartModal({ isOpen, onClose, ticker, name, exchange }: ChartModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative z-10 w-[90vw] h-[85vh] bg-[#0F0F0F] rounded-sm border border-[#2A2A2A] shadow-2xl shadow-black/50 overflow-hidden flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#2A2A2A] bg-black">
          ...
          <button
            onClick={onClose}
            className="flex items-center justify-center w-10 h-10 rounded-sm border border-[#2A2A2A] bg-[#242424] text-[#808080] hover:text-white hover:border-[#3A3A3A] hover:bg-[#2A2A2A] transition-all"
          >
        ...
        {/* Footer Attribution */}
        <div className="px-6 py-2 border-t border-[#2A2A2A] bg-black">
          <a 
