...
export default function Home() {
  ...
  const LandingSection = () => {
    ...
    <div className="h-screen overflow-y-auto">
      ...
      {/* Hero Section */}
      <section id="hero-section" className="relative flex min-h-screen flex-col items-center justify-start overflow-hidden pt-[180px] pb-20">
        {/* Hero Header */}
        ...
        {/* 3D Computer Screen */}
        <div className="relative z-10 mt-3 flex-shrink-0 w-full max-w-[1312px] h-[350px] mx-auto">
          <ComputerScreen3D />
        </div>
